...
function SimulePage() {
  ...
  const handleSimulation = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:3300/simule', requestData);
        ...
        <Row>
          ...
          <Col xs={12} md={6}>
            <form onSubmit={handleFormSubmit}>
              ...
              <DataNascimentoInput dataNascimento={dataNascimento} handleDataNascimentoChange={handleDataNascimentoChange} />
...
function DataNascimentoInput({ dataNascimento, handleDataNascimentoChange }) {
  return (
    <div className="section">
